...
import { getFriendsByUserId } from "@/helpers/get-friends-by-uder-id";
    ...
    <div className="container py-12">
      ...
      {friendsWithLastMessage.length === 0 ? (
        ...
        friendsWithLastMessage.map((friend) => (
          <div
            key={friend.id}
            className="relative rounded-md border-zinc-200 bg-zinc-50 p-3"
          >
              ...
              <div>
                ...
                <p className="mt-1 max-w-md">
                  <span className="text-zinc-400">
                    {friend.parsedLastMessage.senderId === session.user.id
                      ? "You: "
                      : ""}
                  </span>
